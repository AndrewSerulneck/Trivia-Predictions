...
// The legacy venue-lookup registration form. Reached only when
// NEXT_PUBLIC_SELF_SERVE_SIGNUP_ENABLED is off — with the flag on,
// app/owner/register/page.tsx redirects to the /owner/signup wizard before this
// renders. Extracted from that page in Phase 7 so the flag check can live in a
// server component (docs/partner-self-serve-signup-plan.md §4).
