...
/** Category Blitz's equivalent of LiveTriviaChampionAnimation — same sequence
 *  and timing (white flash -> fireworks -> confetti rain -> trophy + badge),
 *  just Category Blitz's own closing line. Kept as a separate component
 *  (rather than parametrizing the Live Trivia one) to match this codebase's
 *  existing convention of one component per animation registry key. */
export const CategoryBlitzChampionAnimation: React.FC<GameplayAnimationProps> = ({ onComplete }) => {
  useEffect(() => {
